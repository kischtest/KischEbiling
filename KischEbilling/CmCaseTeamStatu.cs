...
namespace KischEbilling
{
    ...
    public partial class CmCaseTeamStatu
    {
        public System.Guid CmCaseTeamStatusID { get; set; }
        public int CmCaseTeamLkUp { get; set; }
        public int CaseTeamStatusIndex { get; set; }
