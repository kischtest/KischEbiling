...
namespace KischEbilling
{
    ...
    public partial class ChrgRcpt
    {
        public System.Guid ChrgRcptID { get; set; }
        public int ChrgRcptIndex { get; set; }
        public Nullable<int> ParChrgRcpt { get; set; }
        public int InvMaster { get; set; }
        public int Payor { get; set; }
        public int ChrgCard { get; set; }
        public int ChrgCardBill { get; set; }
